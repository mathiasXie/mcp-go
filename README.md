...
[![Build](https://github.com/mathiasXie/mcp-go/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/mathiasXie/mcp-go/actions/workflows/ci.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/mathiasXie/mcp-go?cache)](https://goreportcard.com/report/github.com/mathiasXie/mcp-go)
[![GoDoc](https://pkg.go.dev/badge/github.com/mathiasXie/mcp-go.svg)](https://pkg.go.dev/github.com/mathiasXie/mcp-go)
...
```bash
go get github.com/mathiasXie/mcp-go
```
